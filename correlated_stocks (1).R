...
#portfolio, and then the probability that this portfolio increased by 5%. This #
#generating data and the next work is repeated n times to use the Monte Carlo  #
#estimation                                                                    #
################################################################################

#Read Data for three stocs
MSFT = read.csv("C:\\Users\\Vivek Vijay\\Desktop\\Quantitative finance lab\\MSFT.csv")
APPLE = read.csv("C:\\Users\\Vivek Vijay\\Desktop\\Quantitative finance lab\\APPLE.csv")
SBUX = read.csv("C:\\Users\\Vivek Vijay\\Desktop\\Quantitative finance lab\\SBUX.csv")
